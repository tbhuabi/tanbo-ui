...
@Component({
  selector: 'ui-editor-quill',
  templateUrl: './editor-quill.component.html',
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: EditorQuillComponent,
    multi: true
  }]
})
export class EditorQuillComponent implements ControlValueAccessor, AfterViewInit, OnDestroy, OnChanges {
